...
var format_RisikoIklimLevelKabupatenKota_1 = new ol.format.GeoJSON();
var features_RisikoIklimLevelKabupatenKota_1 = format_RisikoIklimLevelKabupatenKota_1.readFeatures(json_RisikoIklimLevelKabupatenKota_1, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_RisikoIklimLevelKabupatenKota_1 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_RisikoIklimLevelKabupatenKota_1.addFeatures(features_RisikoIklimLevelKabupatenKota_1);
var lyr_RisikoIklimLevelKabupatenKota_1 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_RisikoIklimLevelKabupatenKota_1, 
                style: style_RisikoIklimLevelKabupatenKota_1,
                popuplayertitle: 'Risiko Iklim Level Kabupaten/Kota',
                interactive: true,
    title: 'Risiko Iklim Level Kabupaten/Kota<br />\
    <img src="styles/legend/RisikoIklimLevelKabupatenKota_1_0.png" /> 1 (Risiko Iklim Sedang)<br />\
    <img src="styles/legend/RisikoIklimLevelKabupatenKota_1_1.png" /> 2 (Risiko Iklim Tinggi)<br />\
    <img src="styles/legend/RisikoIklimLevelKabupatenKota_1_2.png" /> 3 (Risiko Iklim Rendah)<br />' });
...
lyr_GoogleSatellite_0.setVisible(true);lyr_RisikoIklimLevelKabupatenKota_1.setVisible(true);lyr_BatasKabupatenKota_2.setVisible(true);
var layersList = [lyr_GoogleSatellite_0,lyr_RisikoIklimLevelKabupatenKota_1,lyr_BatasKabupatenKota_2];
lyr_RisikoIklimLevelKabupatenKota_1.set('fieldAliases', {'ADM2_EN': 'Kabupaten/Kota', 'ADM1_EN': 'Provinsi', 'NDBI': 'NDBI', 'NDVI': 'NDVI', 'NDWI': 'NDWI', 'Ketinggian': 'Ketinggian', 'Kemiringan': 'Kemiringan', 'SAVI': 'SAVI', 'Jarak_ke_Sungai': 'Jarak ke Polyline Sungai', 'DSI': 'DSI', 'NDDI': 'NDDI', 'NDMI': 'NDMI', 'NPP': 'NPP', 'VHI': 'VHI', 'Banjir': 'Banjir', 'Kekeringan': 'Kekeringan', 'Risiko_Iklim': 'Risiko Iklim', 'Klaster': 'Klaster', 'Tanaman_Pangan': 'Tanaman Pangan', 'Hortikultura': 'Hortikultura', });
