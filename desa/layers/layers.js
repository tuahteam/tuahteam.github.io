...
var format_RisikoIklimLevelDesaKelurahan_1 = new ol.format.GeoJSON();
var features_RisikoIklimLevelDesaKelurahan_1 = format_RisikoIklimLevelDesaKelurahan_1.readFeatures(json_RisikoIklimLevelDesaKelurahan_1, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_RisikoIklimLevelDesaKelurahan_1 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_RisikoIklimLevelDesaKelurahan_1.addFeatures(features_RisikoIklimLevelDesaKelurahan_1);
var lyr_RisikoIklimLevelDesaKelurahan_1 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_RisikoIklimLevelDesaKelurahan_1, 
                style: style_RisikoIklimLevelDesaKelurahan_1,
                popuplayertitle: 'Risiko Iklim Level Desa/Kelurahan',
                interactive: true,
    title: 'Risiko Iklim Level Desa/Kelurahan<br />\
    <img src="styles/legend/RisikoIklimLevelDesaKelurahan_1_0.png" /> 1 (Risiko Iklim Sedang)<br />\
    <img src="styles/legend/RisikoIklimLevelDesaKelurahan_1_1.png" /> 2 (Risiko Iklim Tinggi)<br />\
    <img src="styles/legend/RisikoIklimLevelDesaKelurahan_1_2.png" /> 3 (Risiko Iklim Rendah)<br />' });
...
lyr_RisikoIklimLevelDesaKelurahan_1.set('fieldImages', {'ADM4_EN': 'TextEdit', 'ADM3_EN': 'TextEdit', 'ADM2_EN': 'TextEdit', 'ADM1_EN': 'TextEdit', 'NDBI': 'TextEdit', 'NDVI': 'TextEdit', 'NDWI': 'TextEdit', 'Ketinggian': 'TextEdit', 'Kemiringan': 'TextEdit', 'SAVI': 'TextEdit', 'Jarak_ke_Sungai': 'TextEdit', 'DSI': 'TextEdit', 'NDDI': 'TextEdit', 'NDMI': 'TextEdit', 'NPP': 'TextEdit', 'VHI': 'TextEdit', 'Banjir': 'TextEdit', 'Kekeringan': 'TextEdit', 'Risiko_Iklim': 'TextEdit', 'Klaster': 'TextEdit', 'Tanaman_Pangan': 'TextEdit', 'Hortikultura': 'TextEdit', });
